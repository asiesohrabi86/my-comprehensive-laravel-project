...
Route::prefix('admin')->namespace('Admin')->group(function(){
    ...
    Route::prefix('market')->namespace('Market')->group(function(){
        ...
        Route::prefix('category')->group(function(){
            ...
            // Route::resource('/cetegory',CategoryController::class);
        });
        ...
        Route::prefix('discount')->group(function(){
            ...
            Route::get('/copan/show/users', [DiscountController::class, 'copanShowUsers'])->name('admin.market.discount.copan.copanShowUsers');
        ...
        Route::prefix('order')->group(function(){
            ...
            Route::get('/cancelled', [OrderController::class, 'cancelled'])->name('admin.market.order.cancelled');
    ...
    Route::prefix('notify')->namespace('Notify')->group(function(){
        ...
        // emial:
        Route::prefix('emial')->group(function(){
        ...
        // emial file:
        Route::prefix('emial-file')->group(function(){
    ...
    Route::prefix('ticket')->namespace('Ticket')->group(function(){
        ...
        Route::get('/closeTickets', [TicketController::class, 'closeTickets'])->name('admin.ticket.closeTickets');
...
Route::namespace('SalesProcess')->group(function(){
    ...
    Route::middleware('profile.completion')->group(function(){
        ...
        // api
        Route::get('/edit-address/{address}', [AddressController::class, 'editAddress'])->name('customer.sales-process.edit-address');
        ...
        Route::any('/payment-callback', [CustomerPaymentController::class, 'paymentCallback'])->name('customer.sales-process.payment-call-back');
    });
