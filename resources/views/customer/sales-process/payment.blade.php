                        ...
                        <section class="col-md-9">
                            ...
                            <section class="content-wrapper bg-white p-3 rounded-2 mb-4">
                                ...
                                <section class="payment-select">
                                    ...
                                    <form action="{{route('customer.sales-process.payment-submit')}}" id="payment_submit" method="post">
                                        @csrf
                                        ...
                                        <input type="radio" name="payment_type" value="3" id="cache_payment"/>
                                        <label for="cache_payment" class="col-12 col-md-4 payment-wrapper mb-2 pt-2">
                                            <section class="mb-2">
                            ...
                            <section class="content-wrapper bg-white p-3 rounded-2 cart-total-price">
                                ...
                                @if($order->commonDiscount != null)
                                    ...
                                    <section class="d-flex justify-content-between align-items-center">
                                        ...
                                        <p class="text-danger fw-bolder"><span id="total_discount">{{ priceFormat($order->commonDiscount->minimal_order_amount) }}</span> تومان</p>
                                    </section>
                                @endif
                                <section class="border-bottom mb-3"></section>
                                <section class="d-flex justify-content-between align-items-center">
                                ...
                                <section class="">
                                    <button type="button" onclick="document.getElementById('payment_submit').submit();" class="btn btn-danger d-block w-100"
                                        >تکمیل فرآیند خرید
                                    </button>
                                </section>
...
@section('script')
    {{-- <script>
         $(document).ready(function(){
            $('#cache_payment').click(function(){
                var newDiv = document.createElement('div');
                newDiv.innerHTML = `
                    <section class="input-group input-group-sm">
                        <input type="text" name="cash_receiver" form="payment_submit" class="form-control form-control-sm" placeholder="نام و نام خانوادگی دریافت کننده">
    ...
    <script>
        document.getElementById('cache_payment').addEventListener('click', () => {
            var newDiv = document.createElement('div');
            newDiv.innerHTML = `
                <secdtion class="input-group input-group-sm">
                    <input type="text" name="cash_receiver" form="payment_submit" class="form-control form-control-sm" placeholder="نام و نام خانوادگی دریافت کننده">
                </section>
            `;
