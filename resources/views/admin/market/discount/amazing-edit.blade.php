                        ...
                        <section class="row">
                            <section class="col-12 col-md-6 mb-2">
                                <div class="form-group">
                                    ...
                                    <select type="text" class="form-control form-control-sm" name="product_id">
                            ...
                            <section class="col-12 col-md-6 mb-2">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="percentage" value="{{old('percentage', $amazingSale->percentage)}}" class="form-control form-control-sm">
                                </div>
                                @error('percentage')
                                    <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                        <strong>{{$message}}</strong>
