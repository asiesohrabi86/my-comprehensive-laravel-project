                        ...
                        <section class="row">
                            <section class="col-12 col-md-6 mb-2">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="percentage" value="{{old('percentage')}}" class="form-control form-control-sm">
                                </div>
                                @error('percentage')
                            ...
                            <section class="col-12 col-md-6 mb-2">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="minimal_order_amount" value="{{old('minimal_order_amount')}}" class="form-control form-control-sm">
                                </div>
