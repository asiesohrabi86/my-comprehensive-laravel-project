                        ...
                        <section class="row" id="container">
                            <section class="col-12 col-md-6 mb-2">
                                <div class="form-group">
                                    ...
                                    <input name="code" value="{{old('code')}}" class="form-control form-control-sm" type="text">
                                </div>
                                @error('code')
                            ...
                            {{-- <section class="col-12 col-md-6 mb-2" disabled>
                                <div class="form-group">
                                    <label for="">کاربران</label>
                                    <select id="users" name="user_id" type="text" class="form-control form-control-sm" disabled>
                            ...
                            <section class="col-12 col-md-6 mb-2">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="amount" value="{{old('amount')}}" class="form-control form-control-sm">
                                </div>
                                @error('amount')
                                    <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                        <strong>{{$message}}</strong>
                            ...
                            <section class="col-12 col-md-6 mb-2">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="discount_ceiling" value="{{old('discount_ceiling')}}" class="form-control form-control-sm">
                                </div>
