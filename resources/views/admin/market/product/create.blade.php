                        ...
                        <section class="row">
                            ...
                            <section class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="introduction" id="introduction" rows="6" class="form-control form-control-sm">{{old('introduction')}}</textarea>
                                </div>
                                @error('introduction')
                                    <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                        <strong>{{$message}}</strong>
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-control-sm @error('tags') is-invalid @enderror" type="hidden" name="tags" id="tags" value="{{old('tags')}}">
                            ...
                            <section class="col-12 border-top border-bottom mt-2 py-3 mb-3">
                                ...
                                <section class="col-12 mt-2" id="addWrapper">
                                    <button type="button" id="btn-copy" class="btn btn-sm btn-success">افزودن</button>
                                </section>
                            </section>
                        </section>
                        <section class="col-12">
...
@section('script')
    ...
    <script>
        // addind property section onClick with js:
        // const btnCopy = document.getElementById('btn-copy');
        // const addWrapper = document.getElementById('addWrapper');
        // btnCopy.addEventListener('click', () => {
        //     const copy = `<section class="row">
        //                     <section class="col-6 col-md-3">
        //                                 <div class="form-group">
        ...
        //                             </section>
        //                         </section>`;
        //     addWrapper.insertAdjacentHTML('beforeBegin', copy);
        // });

        // addind property section onClick with jquery:
        $(function () {
