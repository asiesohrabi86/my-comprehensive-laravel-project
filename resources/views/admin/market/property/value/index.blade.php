        ...
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section class="d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
                    <a href="{{route('admin.market.value.create', $categoryAttribute->id)}}" class="btn btn-info btn-sm">ایجاد مقدار جدید فرم کالا</a>
                            ...
                            @foreach ($categoryAttribute->values as $value)
                                <tr>
                                    ...
                                    <td class="text-start width-22-rem">
                                        <a href="{{route('admin.market.value.edit', ['categoryAttribute' =>$categoryAttribute->id, 'value' => $value->id])}}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i> ویرایش</a>
