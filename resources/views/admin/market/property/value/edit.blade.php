                         ...
                         <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-sm" name="product_id">
                                        ...
                                        @foreach ($categoryAttribute->category->products as $product)
                                            <option value="{{$product->id}}" @if (old('product_id', $value->product_id) == $product->id)
                                                selected
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="value" value="{{old('value', json_decode($value->value)->value)}}" class="form-control form-control-sm" type="text">
                                </div>
                                @error('value')
                                    <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                        <strong>{{$message}}</strong>
