                            ...
                            @foreach ($category_attributes as $category_attribute)
                                <tr>
                                    ...
                                    <td class="text-start width-22-rem">
                                        <a href="{{route('admin.market.value.index', $category_attribute->id)}}" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i> ویژگی ها</a>
                                        <a href="{{route('admin.market.property.edit', $category_attribute->id)}}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i> ویرایش</a>
