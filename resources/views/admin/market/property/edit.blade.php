                        ...
                        <section class="row">
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="name" value="{{old('name', $categoryAttribute->name)}}" class="form-control form-control-sm" type="text">
                                </div>
                                @error('name')
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="unit" value="{{old('unit', $categoryAttribute->unit)}}" class="form-control form-control-sm" type="text">
                                </div>
                                @error('unit')
                                    <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                        <strong>{{$message}}</strong>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-sm" name="category_id">
                                        ...
                                        @foreach ($productCategories as $productCategory)
                                            <option value="{{$productCategory->id}}" @if (old('category_id', $categoryAttribute->category_id) == $productCategory->id)
                                                selected
