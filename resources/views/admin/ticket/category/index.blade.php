                        ...
                        <tbody>
                            @foreach ($ticketCategories as $key => $ticketCategory )
                                <tr>
                                    ...
                                    <td>
                                        <input type="checkbox" id="{{$ticketCategory->id}}" data-url="{{route('admin.ticket.category.status', $ticketCategory->id)}}"
                                         onchange="changeStatus({{$ticketCategory->id}})" @if ($ticketCategory->status === 1)
                                            checked 
                                         @endif>
                                    </td>
                                    <td class="text-start width-16-rem">
                                        <a href="{{route('admin.ticket.category.edit', $ticketCategory->id)}}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i> ویرایش</a>
