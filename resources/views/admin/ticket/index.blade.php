                        ...
                        <tbody>
                            @foreach($tickets as $ticket)
                                <tr>
                                    ...
                                    {{-- <td>{{$ticket->user->fist_name.' '.$ticket->user->last_name}}</td> --}}
                                    ...
                                    <td class="text-start width-16-rem">
                                        <a href="{{route('admin.ticket.show', $ticket->id)}}" class="btn btn-sm btn-info text-white"><i class="fa fa-eye"></i> مشاهده</a>
                                        <a href="{{route('admin.ticket.change', $ticket->id)}}" class="btn btn-sm btn-warning"><i class="fa fa-{{$ticket->status == 1? 'folder-open' : 'close'}}"></i> 
