                            ...
                            @foreach($roles as $role)
                                <tr>
                                    ...
                                    <td class="text-start width-22-rem">
                                        <a href="{{route('admin.user.role.permission-form', $role->id)}}" class="btn btn-sm btn-success"><i class="fa fa-user-graduate"></i> دسترسی ها</a>
                                        <a href="{{route('admin.user.role.edit', $role->id)}}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i> ویرایش</a>
