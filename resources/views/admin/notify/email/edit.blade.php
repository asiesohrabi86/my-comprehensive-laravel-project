                    ...
                    <form action="{{route('admin.notify.email.update', $email->id)}}" method="post">
                        ...
                        <section class="row">
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-control-sm" name="subject" type="text" value="{{old('subject', $email->subject)}}">
                                </div>
                                @error('subject')
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="published_at_view" class="form-control form-control-sm" value="{{$email->published_at}}"> 
                                </div>
                                @error('published_at')
                                    <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                        <strong>{{$message}}</strong>
                        ...
                        <section class="col-12 mt-1">
                            <div class="form-group">
                                ...
                                <textarea rows="4" class="form-control form-control-sm" name="body">{{old('body', $email->body)}}</textarea>
                            </div>
                            @error('body')
                                <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                    <strong>{{$message}}</strong>
