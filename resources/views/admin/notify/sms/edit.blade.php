                        ...
                        <section class="row">
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-control-sm" type="text" name="title" value="{{old('title', $sms->title)}}">
                                </div>
                                @error('title')
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="published_at" value="{{$sms->published_at}}" id="published_at" class="form-control form-control-sm d-none">
                                    <input id="published_at_view" value="{{$sms->published_at}}" class="form-control form-control-sm"> 
                                </div>
                                @error('published_at')
                                    <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                        <strong>{{$message}}</strong>
                            ...
                            <section class="col-12 mt-1">
                                <div class="form-group">
                                    ...
                                    <textarea rows="4" class="form-control form-control-sm" name="body">{{old('body', $sms->body)}}</textarea>
                                </div>
                                @error('body')
                                    <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                        <strong>{{$message}}</strong>
