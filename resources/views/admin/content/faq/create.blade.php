...
@section('content')
    <nav aria-label="breadcrumb">
        ...
        <li class="breadcrumb-item font-size-12 active" aria-current="page">ایجاد سئوال</li>
        </ol>
    </nav>
                        ...
                        <section class="row">
                            <section class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="question" class="form-control form-control-sm @error('question')
                                       is-invalid 
                                    @enderror" value="{{old('question')}}">
                                </div>
                                @error('question')
                            ...
                            <section class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control form-control-sm @error('answer')
                                       is-invalid 
                                    @enderror" rows="4" name="answer" id="answer" type="text">{{old('answer')}}</textarea>
                                </div>
                                @error('answer')
                                    <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                        <strong>{{$message}}</strong>
