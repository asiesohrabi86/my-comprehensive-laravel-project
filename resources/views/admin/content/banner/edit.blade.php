                        ...
                        <section class="row">
                            <section class="col-12 col-md-6 my-2">
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-control-sm @error('title') is-invalid @enderror" type="text" name="title" value="{{old('title', $banner->title)}}">
                                </div>
                                @error('title')
                            ...
                            <section class="col-12 col-md-6 my-2">
                                ...
                                @enderror
                                <section class=mt-2>
                                   <img src="{{asset($banner->image)}}" width="300"> 
                                </section>
                            </section>
                            <section class="col-12 col-md-6 my-2">
                                <div class="form-group">
                            ...
                            <section class="col-12 col-md-6 my-2">
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-control-sm @error('url') is-invalid @enderror" name="url" value="{{old('url', $banner->url)}}">
                                </div>
                                @error('url')
                                    <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                        <strong>{{$message}}</strong>
