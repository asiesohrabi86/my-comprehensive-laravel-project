                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <img src="{{asset($postCategory->image['indexArray'][$postCategory->image['currentImage']])}}" alt="" width="100" height="50px">
                                </td>
                                ...
                                <td>
                                    ...
                                    <label for="">
                                        <input type="checkbox" name="" data-url = "{{route('admin.content.category.status', $postCategory->id)}}" id="{{$postCategory->id}}" onchange="changeStatus({{$postCategory->id}})" @if($postCategory->status === 1)
                                          checked
                                        @endif>
                                    </label>
                                </td>
                                <td class="width-16-rem">
                                    <a href="{{route('admin.content.category.edit', $postCategory->id)}}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i> ویرایش</a>
