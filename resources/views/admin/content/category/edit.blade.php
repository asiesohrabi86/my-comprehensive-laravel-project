                        ...
                        <section class="row">
                            <section class="col-12 col-md-6 my-2">
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-control-sm @error('name') is-invalid @enderror" type="text" name="name" id="name" value="{{old('name',$postCategory->name)}}">
                                </div>
                                @error('name')
                            ...
                            <section class="col-12 col-md-6 my-2">
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-control-sm @error('tags') is-invalid @enderror" type="hidden" name="tags" id="tags" value="{{old('tags', $postCategory->tags)}}">
                                    ...
                                    @foreach ($postCategory->image['indexArray'] as $key => $value)
                                        <section class="col-md-{{ 6/ $number}}">
                                            <div class="form-check">
                                                <input type="radio" name="current-image" class="form-ckeck-input" value="{{$key}}" id="{{$number}}" @if ($postCategory->image['currentImage'] == $key)
                                                 checked 
                                                @endif
                                                >
                            ...
                            <section class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control form-control-sm @error('description') is-invalid @enderror" rows="6" name="description" id="description">{{old('description',$postCategory->description)}}</textarea>
                                </div>
                                @error('description')
                                    <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                        <strong>{{$message}}</strong>
