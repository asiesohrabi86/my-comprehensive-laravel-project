                        ...
                        <section class="row">
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-control-sm" type="text" name="title" value="{{old('title', $post->title)}}">
                                </div>
                                @error('title')
                                    ...
                                    @foreach ($post->image['indexArray'] as $key => $value)
                                        <section class="col-md-{{ 6/ $number}}">
                                            <div class="form-check">
                                                <input type="radio" name="current-image" class="form-ckeck-input" value="{{$key}}" id="{{$number}}" @if ($post->image['currentImage'] == $key)
                                                 checked 
                                                @endif
                                                >
                            ...
                            <section class="col-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-control-sm @error('tags') is-invalid @enderror" type="hidden" name="tags" id="tags" value="{{old('tags', $post->tags)}}">
                            ...
                            <section class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="summary" name="summary" rows="4" class="form-control form-control-sm">{{old('summary', $post->summary)}}</textarea> 
                                </div>
                                @error('summary')
                                    <span role="alert" class="alert_required bg-danger text-white p-1 rounded">
                                        <strong>{{$message}}</strong>
                            ...
                            <section class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="body" id="body" rows="4" class="form-control form-control-sm">{{old('body', $post->body)}}</textarea> 
                                </div>
                                @error('body')
                                    <span role="alert" class="alert_required bg-danger text-white p-1 rounded">
                                        <strong>{{$message}}</strong>
