                    ...
                    <form action="{{route('admin.content.page.store')}}" method="post" id="form">
                        ...
                        <section class="row">
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="title" value="{{old('title')}}" class="form-control form-control-sm @error('title') is-invalid @enderror" type="text">
                                </div>
                                @error('title')
                        ...
                        <section class="col-12">
                            <div class="form-group">
                                ...
                                <textarea id="body" rows="4" name="body" class="form-control form-control-sm @error('body') is-invalid @enderror" type="text">{{old('body')}}</textarea>
                            </div>
                            @error('body')
                                    <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                        <strong>{{$message}}</strong>
