                        ...
                        <tbody>
                            @foreach ($pages as $key => $page)
                                <tr>
                                    ...
                                    <td>
                                        <label for="">
                                            <input type="checkbox" name="status" id="{{$page->id}}" data-url="{{route('admin.content.page.status', $page->id)}}" onchange="changeStatus({{$page->id}})" @if ($page->status === 1)
                                                checked
                                            @endif>
                                        </label>
                                    </td>
                                    <td class="text-start width-16-rem">
                                        <a href="{{route('admin.content.page.edit', $page->id)}}" class="btn btn-sm btn-primary ms-2"><i class="fa fa-edit"></i> ویرایش</a>
