...
class MenuController extends Controller
{
    ...
    public function store(MenuRequest $request)
    {
       ...
       $menu = Menu::create($inputs);
        return redirect()->route('admin.content.menu.index')->with('swal-success', 'منوی جدید با موفقییت ثبت شد.');
    }
    ...
    {
        $menu->delete();
        return redirect()->route('admin.content.menu.index')->with('swal-success', 'منوی جدید شما با موفقیت حذف شد');
    }
