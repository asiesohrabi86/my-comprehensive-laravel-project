...
class DiscountController extends Controller
{
  ...
  public function copanShowUsers(){
    $users = User::all();
    if($users){
  ...
  public function commonDiscountStore(CommonDiscountRequest $request)
  {
    ...
    return redirect()->route('admin.market.discount.commonDiscount')->with('swal-success', 'کد تخفیف شما با موفقیت ثبت شد');
  }
    ...
    public function amazingSaleStore(AmazingSaleRequest $request)
  {
    ...
    return redirect()->route('admin.market.discount.amazingSale')->with('swal-success', 'تخفیف شما با موفقیت ثبت شد');
  }
