...
return [
    ...
    */
    ...
    'required_with' => 'تکمیل گزینه :attribute زمانی که :values موجود است الزامی است',
    ...
    */
    ...
    'attributes' => [
        ...
        'city_id' => 'شهر',
        'no' => 'پلاک',
        'recepient_first_name' => 'نام گیرنده',
        'recepient_last_name' => 'نام خانوادگی گیرنده',
        'address_id' => 'آدرس',
        'delivery_id' => 'نحوه ارسال',
        'copan' => 'کد تخفیف',
        'cash_receiver' => 'دریافت کننده',
